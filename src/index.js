    ...
    <div>
      ...
      <div className='main'>
      {
        <Routes>
          ...
          <Route path = '/routines/:routineId' element={<RoutineDetail routines={routines} setRoutines={setRoutines} user={user} setActivities={setActivities} activities={activities}/>}/>
